...
Tasks allocated to Functions:
  computeTax(maritalStatus, income) - This determines the taxes the user
    owes based upon their marital status and his or her taxable income.
  netIncome(income, tax) - This determines the net income of the user
    based upon the user's income and the taxes he or she owes.
'''
...
def main():
  ...
  while name:
    ...
    while not maritalStatusValidation(maritalStatus):
      print("You did not enter a valid marital status. Please enter either\
single or married.")
      maritalStatus = input("Are you single or married? ")
